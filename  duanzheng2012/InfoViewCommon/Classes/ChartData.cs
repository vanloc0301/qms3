...
namespace InfoViewCommon.Classes
{
                    ...
                    {
                        {
                            ...
                            try
                            {
                                InfoViewCommon.Classes.BaseOperate boperate = new InfoViewCommon.Classes.BaseOperate();
                ...
                case 3://月
                    {
                        ...
                        string strSQL = "DECLARE	@return_value int EXEC	@return_value = [rfidtest].[GetCenterMonthCount] @Month = N'" + sttime + "',@numofday="+InfoViewCommon.Classes.Datetimecalc.daysofmonth(dt).ToString()+",@station = 0";
                        string strTable = " [db_rfidtest].[rfidtest].[dbo.goods]";
                        // MessageBox.Show(strSQL);
                        try
                        {
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i <InfoViewCommon.Classes.Datetimecalc.daysofmonth(dt); i++)
                            {
