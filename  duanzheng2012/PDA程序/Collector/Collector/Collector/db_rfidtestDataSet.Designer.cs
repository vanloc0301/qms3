...
namespace Collector {
    ...
    public partial class db_rfidtestDataSet : global::System.Data.DataSet {
        ...
        public partial class _dbo_BoxDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public _dbo_BoxRow Add_dbo_BoxRow(string BoxCardID, int ID, int BoxCardState) {
...
namespace Collector.db_rfidtestDataSetTableAdapters {
...
SELECT ID, BoxCardID, TruckNo, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM [dbo.Goods] WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [rfidtest].[dbo.Goods] SET [BoxCardID] = @BoxCardID, [TruckNo] = @TruckNo, [StartTime] = @StartTime, [EndTime] = @EndTime, [State] = @State, [Weight] = @Weight, [StartStationID] = @StartStationID, [EndStationID] = @EndStationID WHERE (([ID] = @Original_ID));
SELECT ID, BoxCardID, TruckNo, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM [dbo.Goods] WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = @"INSERT INTO [dbo.Goods]
     (BoxCardID, TruckNo, StartTime, EndTime, StartStationID, Weight,State)
VALUES (@BoxCardID,@TruckNo,@StartTime,@EndTime,@StartStationID, @Weight,@State); 
SELECT ID, BoxCardID, TruckNo, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM Goods WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._commandCollection[2].CommandText = "SELECT COUNT(*) AS Expr1\r\nFROM [dbo.Goods]\r\nWHERE (BoxCardID = @BoxCardID) AND (T" +
                "ruckNo = @TruckNo) AND (StartTime = @StartTime) AND  (StartStationID = @StartSta" +
                "tionID)";
            ...
            this._commandCollection[3].CommandText = "UPDATE [dbo.Goods]\r\nSET EndTime = @EndTime, [Weight] = @Weight\r\nWHERE (BoxCardID " +
                "= @BoxCardID) AND (TruckNo = @TruckNo) AND (StartTime = @StartTime) AND (StartSt" +
                "ationID = @StartStationID)";
        ...
        public virtual int InsertQueryForAll(string BoxCardID, string TruckNo, string StartTime, string EndTime, global::System.Nullable<int> StartStationID, global::System.Nullable<double> Weight, global::System.Nullable<int> State) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual object ScalarQueryBySendInfo(string BoxCardID, string TruckNo, string StartTime, global::System.Nullable<int> StartStationID) {
        ...
        public virtual int UpdateQueryEndTime(string EndTime, global::System.Nullable<double> Weight, string BoxCardID, string TruckNo, string StartTime, global::System.Nullable<int> StartStationID) {
            ...
            if ((BoxCardID == null)) {
                ...
                command.Parameters[2].Value = ((string)(BoxCardID));
            }
            if ((TruckNo == null)) {
                command.Parameters[3].Value = global::System.DBNull.Value;
            }
            ...
            if ((StartStationID.HasValue == true)) {
                command.Parameters[5].Value = ((int)(StartStationID.Value));
            }
            else {
                command.Parameters[5].Value = global::System.DBNull.Value;
            }
    ...
    public partial class dbo_BoxTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo.Box] ([BoxCardID], [ID], [BoxCardState]) VALUES (@BoxCardID, @ID" +
                ", @BoxCardState);\r\nSELECT BoxCardID, ID, BoxCardState FROM [dbo.Box] WHERE (ID =" +
                " @ID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@BoxCardID";
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo.Box] SET [BoxCardID] = @BoxCardID, [ID] = @ID, [BoxCardState] = @BoxC" +
                "ardState WHERE (([ID] = @Original_ID));\r\nSELECT BoxCardID, ID, BoxCardState FROM" +
                " [dbo.Box] WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@BoxCardID";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT BoxCardID, ID, BoxCardState\r\nFROM [dbo.Box]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT COUNT(*) AS Count\r\nFROM [dbo.Box]\r\nWHERE (BoxCardID = @BoxCardID) AND (Box" +
                "CardState = 1)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::System.Data.SqlClient.SqlParameter param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@BoxCardID";
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string BoxCardID, int ID, int BoxCardState) {
            if ((BoxCardID == null)) {
                throw new global::System.ArgumentNullException("BoxCardID");
            }
            else {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string BoxCardID, int ID, int BoxCardState, int Original_ID) {
            if ((BoxCardID == null)) {
                throw new global::System.ArgumentNullException("BoxCardID");
            }
            else {
        ...
        public virtual int Update(string BoxCardID, int BoxCardState, int Original_ID) {
            return this.Update(BoxCardID, Original_ID, BoxCardState, Original_ID);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual global::System.Nullable<int> ScalarQueryBySendInfo(string BoxCardID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((BoxCardID == null)) {
                throw new global::System.ArgumentNullException("BoxCardID");
            }
    ...
    public partial class dbo_DriverTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual global::System.Nullable<int> ScalarQueryBySendInfo(string TruckNo) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((TruckNo == null)) {
                throw new global::System.ArgumentNullException("TruckNo");
            }
