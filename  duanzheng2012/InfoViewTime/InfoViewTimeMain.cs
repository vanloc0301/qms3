...
namespace InfoViewTime
{
    public partial class InfoViewTimeMain : Form
    {

        private InfoViewCommon.Classes.ChartData chartdata = new InfoViewCommon.Classes.ChartData();
        ...
        {
            InfoViewCommon.Classes.visifire vschart = new InfoViewCommon.Classes.visifire();
