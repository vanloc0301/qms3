                    ...
                    {
                        {
                            ...
                            try
                            {
                                DTQMS3New.Classes.BaseOperate boperate = new DTQMS3New.Classes.BaseOperate();
                ...
                case 3://月
                    {
                        ...
                        string strSQL = "DECLARE	@return_value int EXEC	@return_value = [rfidtest].[GetCenterMonthCount] @Month = N'" + sttime + "',@numofday="+DTQMS3New.Classes.Datetimecalc.daysofmonth(dt).ToString()+",@station = 0";
                        string strTable = " [db_rfidtest].[rfidtest].[dbo.goods]";
                        // MessageBox.Show(strSQL);
                        try
                        {
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i <DTQMS3New.Classes.Datetimecalc.daysofmonth(dt); i++)
                            {
