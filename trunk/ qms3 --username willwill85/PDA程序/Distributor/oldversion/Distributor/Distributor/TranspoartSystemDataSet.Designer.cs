...
// 
// 此源代码是由 Microsoft.CompactFramework.Design.Data 2.0.50727.3603 版自动生成。
// 
namespace Distributor {
    ...
    public partial class TranspoartSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class BoxDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public BoxRow AddBoxRow(string BoxCardID, string BoxCardState) {
            ...
            private void InitClass() {
                ...
                this.columnBoxCardState = new global::System.Data.DataColumn("BoxCardState", typeof(string), null, global::System.Data.MappingType.Element);
                ...
                this.columnBoxCardState.MaxLength = 16;
            }
        ...
        public partial class GoodsDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public GoodsRow AddGoodsRow(int ID, string CardID, string DriverCardID, System.DateTime StartTime, System.DateTime EndTime, int State, double Weight, int StartStationID, int EndStationID) {
            ...
            private void InitClass() {
                ...
                this.columnCardID.MaxLength = 16;
                this.columnDriverCardID.MaxLength = 16;
        ...
        public partial class BoxRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public string BoxCardState {
                get {
                    return ((string)(this[this.tableBox.BoxCardStateColumn]));
                }
                set {
        ...
        public partial class GoodsRow : global::System.Data.DataRow {
            ...
            public string CardID {
                get {
                    return ((string)(this[this.tableGoods.CardIDColumn]));
                }
                set {
                    this[this.tableGoods.CardIDColumn] = value;
                }
            }
            ...
            public string DriverCardID {
                get {
                    try {
                        return ((string)(this[this.tableGoods.DriverCardIDColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("表“Goods”中列“DriverCardID”的值为 DBNull。", e);
                    }
                }
                set {
                    this[this.tableGoods.DriverCardIDColumn] = value;
                }
            }
            ...
            public System.DateTime StartTime {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableGoods.StartTimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public System.DateTime EndTime {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableGoods.EndTimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsDriverCardIDNull() {
                return this.IsNull(this.tableGoods.DriverCardIDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetDriverCardIDNull() {
                this[this.tableGoods.DriverCardIDColumn] = global::System.Convert.DBNull;
            }
...
namespace Distributor.TranspoartSystemDataSetTableAdapters {
    ...
    public partial class BoxTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Connection = new global::System.Data.SqlClient.SqlConnection("Data Source=192.168.1.5,1433;Initial Catalog=TranspoartSystem;User ID=test;Passwo" +
                    "rd=64293849");
            this._commandCollection[1].CommandText = "SELECT COUNT(*) AS Count\r\nFROM Box\r\nWHERE (BoxCardID = @PARAM1) AND (BoxCardState" +
                " = 1)";
    ...
    public partial class DriverTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Connection = new global::System.Data.SqlClient.SqlConnection("Data Source=192.168.1.5,1433;Initial Catalog=TranspoartSystem;User ID=test;Passwo" +
                    "rd=64293849");
            this._commandCollection[1].CommandText = "SELECT COUNT(*) AS Count\r\nFROM Driver\r\nWHERE (DriverCardID = @PARAM1) AND (TruckN" +
                "o = @PARAM2)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::System.Data.SqlClient.SqlParameter param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@PARAM1";
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual global::System.Nullable<int> ScalarQueryByCarIdNo(string PARAM1, string PARAM2) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((PARAM1 == null)) {
                throw new global::System.ArgumentNullException("PARAM1");
            }
    ...
    public partial class GoodsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Goods] ([ID], [CardID], [DriverCardID], [StartTime], [EndTime], [State], [Weight], [StartStationID], [EndStationID]) VALUES (@ID, @CardID, @DriverCardID, @StartTime, @EndTime, @State, @Weight, @StartStationID, @EndStationID);
SELECT ID, CardID, DriverCardID, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM Goods WHERE (ID = @ID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@ID";
            param.DbType = global::System.Data.DbType.Int32;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Goods] SET [ID] = @ID, [CardID] = @CardID, [DriverCardID] = @DriverCardID, [StartTime] = @StartTime, [EndTime] = @EndTime, [State] = @State, [Weight] = @Weight, [StartStationID] = @StartStationID, [EndStationID] = @EndStationID WHERE (([ID] = @Original_ID));
SELECT ID, CardID, DriverCardID, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM Goods WHERE (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@ID";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT ID, CardID, DriverCardID, StartTime, EndTime, State, Weight, StartStationI" +
                "D, EndStationID FROM dbo.Goods";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = new global::System.Data.SqlClient.SqlConnection("Data Source=192.168.1.5,1433;Initial Catalog=TranspoartSystem;User ID=test;Passwo" +
                    "rd=64293849");
            this._commandCollection[1].CommandText = "DELETE FROM [dbo].[Goods]\r\nWHERE (BoxCardID = @PARAM1) AND (StartTime <> \'\') AND " +
                "(EndTime = \'\')";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::System.Data.SqlClient.SqlParameter param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@PARAM1";
            ...
            this._commandCollection[2].Connection = new global::System.Data.SqlClient.SqlConnection("Data Source=192.168.1.5,1433;Initial Catalog=TranspoartSystem;User ID=test;Passwo" +
                    "rd=64293849");
            ...
            this._commandCollection[3].Connection = new global::System.Data.SqlClient.SqlConnection("Data Source=192.168.1.5,1433;Initial Catalog=TranspoartSystem;User ID=test;Passwo" +
                    "rd=64293849");
            this._commandCollection[3].CommandText = "SELECT COUNT(*) AS Count\r\nFROM Goods\r\nWHERE (BoxCardID = @PARAM1) AND (StartTime " +
                "<> \'\') AND (EndTime IS NULL)";
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int ID, string CardID, string DriverCardID, global::System.Nullable<global::System.DateTime> StartTime, global::System.Nullable<global::System.DateTime> EndTime, int State, double Weight, global::System.Nullable<int> StartStationID, global::System.Nullable<int> EndStationID) {
            ...
            if ((DriverCardID == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(DriverCardID));
            }
            ...
            if ((StartStationID.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((int)(StartStationID.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[7].Value = global::System.DBNull.Value;
            }
            if ((EndStationID.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[8].Value = ((int)(EndStationID.Value));
            }
            else {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ID, string CardID, string DriverCardID, global::System.Nullable<global::System.DateTime> StartTime, global::System.Nullable<global::System.DateTime> EndTime, int State, double Weight, global::System.Nullable<int> StartStationID, global::System.Nullable<int> EndStationID, int Original_ID) {
            ...
            if ((DriverCardID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(DriverCardID));
            }
            if ((StartTime.HasValue == true)) {
            ...
            if ((StartStationID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(StartStationID.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[7].Value = global::System.DBNull.Value;
            }
            if ((EndStationID.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(EndStationID.Value));
            }
            else {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CardID, string DriverCardID, global::System.Nullable<global::System.DateTime> StartTime, global::System.Nullable<global::System.DateTime> EndTime, int State, double Weight, global::System.Nullable<int> StartStationID, global::System.Nullable<int> EndStationID, int Original_ID) {
            return this.Update(Original_ID, CardID, DriverCardID, StartTime, EndTime, State, Weight, StartStationID, EndStationID, Original_ID);
        }
        ...
        public virtual int InsertQueryDistributor(string BoxCardID, string TruckNo, string StartTime, global::System.Nullable<int> StartStationID) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual object ScalarQueryByBoxIdTryInsert(string PARAM1) {
