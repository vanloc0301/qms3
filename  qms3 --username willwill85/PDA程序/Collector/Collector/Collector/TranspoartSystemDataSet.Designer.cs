...
namespace Collector.TranspoartSystemDataSetTableAdapters {
...
SELECT ID, BoxCardID, TruckNo, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM Goods WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"INSERT INTO Goods
     (BoxCardID, TruckNo, StartTime, EndTime, StartStationID)
VALUES (@BoxCardID,@TruckNo,@StartTime,@EndTime,@StartStationID); 
SELECT ID, BoxCardID, TruckNo, StartTime, EndTime, State, Weight, StartStationID, EndStationID FROM Goods WHERE (ID = SCOPE_IDENTITY())";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            global::System.Data.SqlClient.SqlParameter param = new global::System.Data.SqlClient.SqlParameter();
            param.ParameterName = "@BoxCardID";
            ...
            this._commandCollection[3].CommandText = "UPDATE Goods\r\nSET EndTime = @EndTime\r\nWHERE (BoxCardID = @BoxCardID) AND (TruckNo" +
                " = @TruckNo) AND (StartTime = @StartTime) AND (StartStationID = @StartStationID)" +
                "\r\n";
        ...
        public virtual int InsertQueryForAll(string BoxCardID, string TruckNo, string StartTime, string EndTime, global::System.Nullable<int> StartStationID) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            if ((BoxCardID == null)) {
                throw new global::System.ArgumentNullException("BoxCardID");
            }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        public virtual global::System.Nullable<int> ScalarQueryBySendInfo(string BoxCardID, string TruckNo, string StartTime, global::System.Nullable<int> StartStationID) {
        ...
        public virtual int UpdateQueryEndTime(string EndTime, string BoxCardID, string TruckNo, string StartTime, global::System.Nullable<int> StartStationID) {
